package com.example.eilco.Movieappantoine.adapter;
...
import com.example.eilco.Movieappantoine.R;
            ...
            view.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        ...
                        Toast.makeText(v.getContext(), "You clicked" + clickedDataItem.getName(), Toast.LENGTH_SHORT);
